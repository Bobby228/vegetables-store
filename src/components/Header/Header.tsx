...
import empty from '../../icons/cart_empty.svg';
    ...
    <header className={styles.header}>
      ...
      >
        ...
        <Popover.Dropdown p={0} style={{ overflow: 'hidden' }}>
          {items.length === 0 ? (
            <Flex direction="column" justify="center" align="center" py={40} gap={24}>
              <Image w={117} src={empty} />
                ...
                <div key={item.id}>
                    ...
                    <Group gap={12} wrap="nowrap">
                      ...
                      <div>
                        <Text fw={600} size="sm" mb={10}>
                          {item.name.split('-')[0]} <span className={styles.header__kg}>{item.name.split('-')[1]}</span>
                        </Text>
                  ...
                  {index < items.length - 1 && (
                    <Divider
                      my={16}
                      ml={72}
                      style={{ borderTop: '1px solid rgba(222, 226, 230, 1)' }}
                    />
                  )}
                </div>
              ))}
